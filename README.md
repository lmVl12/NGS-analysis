...
Synteny and structural comparison were performed using Mauve, with reference alignment against E. coli 55989.

## 3. Assembly Quality Assessment

The quality of the de novo assembly was evaluated using QUAST. The key metrics are summarized below:
